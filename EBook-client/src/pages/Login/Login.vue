  ...
  <body class="text-center">
    <div class="center">
      <el-form v-show="Login === 'SignIn'" :model="SignIn" label-width="7em" ref="SignIn" :rules="signin_rules">
        ...
        <el-form-item>
          <p class="mt-5 mb-3 text-muted">&copy; 2021 吴仪坤</p>
        </el-form-item>
      </el-form>
      <el-form v-show="Login === 'SignUp'" :model="SignUp" :rules="signup_rules" label-width="7em" ref="SignUp">
        ...
        <el-form-item label="手机号" prop="account">
          <el-row>
            <el-col :span="16">
              <el-input placeholder="请输入手机号" v-model="SignUp.account"></el-input>
            </el-col>
            <!-- <el-col :span="8" v-show="!countDown"><el-button type="success" plain  @click="getCode(SignUp.account)">获取验证码</el-button></el-col> -->
            <el-col :span="8" v-show="!countDown">
              <el-button type="success" plain :disabled="!phoneCheck" @click="getCode(SignUp.account)">获取验证码</el-button>
            </el-col>
            <el-col :span="8" v-show="countDown">
              <el-button type="success" plain disabled>{{count}}s后重发</el-button>
            </el-col>
          </el-row>
        </el-form-item>
        ...
        <el-form-item>
          <p class="mt-5 mb-3 text-muted">&copy; 吴仪坤</p>
        </el-form-item>
      </el-form>
