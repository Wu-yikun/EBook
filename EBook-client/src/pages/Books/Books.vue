<template>
  <div class="container-fluid">
    ...
    <el-dialog title="添加书籍" :visible.sync="dialogVisible" width="60%">
      <div>
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          ...
          <el-form-item label="页数" prop="pages">
            <el-row>
              <el-col :span="24" class="mb-2">
                <el-input-number v-model="form.pages" controls-position="right" :min="1" size="mini"></el-input-number>
              </el-col>
            </el-row>
          </el-form-item>
          <el-form-item label="库存" prop="stock">
            <el-row>
              <el-col :span="24" class="mb-2">
                <el-input-number v-model="form.stock" controls-position="right" :min="1" size="mini"></el-input-number>
              </el-col>
            </el-row>
          </el-form-item>
          ...
          <el-form-item label="封面">
            <el-row>
              <el-col :span="10">
                <el-upload :on-remove="onRemove" :on-success="onSuccess" :on-error="onError" :before-remove="beforeRemove" :http-request="httpRequest" list-type="picture" action="http://fuck" :file-list="fileList">
