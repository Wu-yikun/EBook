  ...
  <div>
    <div class="container">
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column align="right" prop="allow" label="用户状态">
          <template slot-scope="scope">
            <div class="user_state">
              <el-switch style="display: block" v-model="scope.row.allowed" active-color="#13ce66" inactive-color="#ff4949" active-text="通行" inactive-text="禁用" @change="changeAllow(scope.row.account)">
              </el-switch>
            </div>
          </template>
        </el-table-column>
