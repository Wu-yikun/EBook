<template>
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-2" v-if="!isManager">
        <div class="row mt-5 mb-2">
          ...
          <i class="iconfont icon-jia col-md-3" @click="add" :style="count<book.stock? 'cursor: pointer':''" :class="count<book.stock?'text-danger':''"></i>
        </div>
    ...
    <hr>
    <el-dialog :title="isManager? '书籍信息修改':'书籍详情'" :visible.sync="dialogVisible" width="60%">
      <!-- 用户: 仅详情 -->
      <div v-if="!isManager">
        <div class="mt-2">
          <div class="row mb-3">
      ...
      <div v-else>
        <el-form ref="form" :model="detail" label-width="80px">
          ...
          <el-form-item label="库存">
            <el-row>
              <el-col :span="24" class="mb-2">
                <el-input-number v-model="detail.stock" controls-position="right" :min="1" size="mini"></el-input-number>
              </el-col>
            </el-row>
          </el-form-item>
          ...
          <el-form-item label="封面">
            <el-row>
              <el-col :span="15">
                <el-upload :on-remove="onRemove" :on-success="onSuccess" :on-error="onError" :before-remove="beforeRemove" :http-request="httpRequest" list-type="picture" action="/api/upload" :file-list="fileList">
